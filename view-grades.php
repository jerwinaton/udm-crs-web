        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class=" col-12">
                        ...
                        <tbody>
                            <?php
                            $select_stmt = $conn->prepare("SELECT * FROM xyashmqn_udm.grades WHERE school_year='2020-2021' AND semester='summer' AND student_no=:student_username"); //prepared selct statement
                            $select_stmt->execute(array(':student_username' => $_SESSION["student_username"]));
                            while ($row = $select_stmt->fetch(PDO::FETCH_ASSOC)) {
                                echo '<tr>
                                        <td>' . $row["subject_code"] . ' </td>
                ...
                <div class=" col-12">
                        ...
                        <tbody>
                            <?php
                            $select_stmt = $conn->prepare("SELECT * FROM xyashmqn_udm.grades WHERE school_year='2020-2021' AND semester='2nd' AND student_no=:student_username"); //prepared selct statement
                            $select_stmt->execute(array(':student_username' => $_SESSION["student_username"]));
                            while ($row = $select_stmt->fetch(PDO::FETCH_ASSOC)) {
                                echo '<tr>
                                        <td>' . $row["subject_code"] . ' </td>
                ...
                <div class=" col-12">
                        ...
                        <tbody>
                            <?php
                            $select_stmt = $conn->prepare("SELECT * FROM xyashmqn_udm.grades WHERE school_year='2020-2021' AND semester='1st' AND student_no=:student_username"); //prepared selct statement
                            $select_stmt->execute(array(':student_username' => $_SESSION["student_username"]));
                            while ($row = $select_stmt->fetch(PDO::FETCH_ASSOC)) {
                                echo '<tr>
                                        <td>' . $row["subject_code"] . ' </td>
